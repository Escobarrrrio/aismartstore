...
// Old/alternate contact URLs that were linked externally or generated by
// earlier versions of the site. Mirrors the 301 list in vercel.json and
// public/_redirects — keep the three in step.
const LEGACY_CONTACT_PATHS = [
  "/contact-us",
  "/contactus",
  "/contact.html",
  "/contact-support",
